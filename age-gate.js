...
(function () {
  ...
  var css = "" +
    ...
    ".sb-gate-title{font-size:20px;line-height:1.25;font-weight:700;margin:0;color:#fff;text-align:center;}" +
    ...
    overlay.innerHTML =
      '<div class="sb-gate-card" tabindex="-1">' +
        ...
        '<div class="sb-gate-body">' +
          '<p class="sb-gate-lede" id="sb-gate-lede">By clicking &ldquo;Enter&rdquo; or continuing to use this website, you confirm that:</p>' +
        ...
        '<div class="sb-gate-foot">' +
          '<button type="button" class="sb-gate-btn sb-gate-accept" id="sb-gate-accept">I am 21 or older &mdash; Enter</button>' +
          '<button type="button" class="sb-gate-btn sb-gate-exit" id="sb-gate-exit">Leave site</button>' +
        '</div>' +
      '</div>';
